...
$TCA['tx_myaudioshop_domain_model_payment'] = array(
	'ctrl' => $TCA['tx_myaudioshop_domain_model_payment']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_myaudioshop_domain_model_payment.pid=###CURRENT_PID### AND tx_myaudioshop_domain_model_payment.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:myaudioshop/Resources/Private/Language/locallang_db.xlf:tx_myaudioshop_domain_model_payment.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'

...
$TCA['tx_myaudioshop_domain_model_brand'] = array(
	'ctrl' => $TCA['tx_myaudioshop_domain_model_brand']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_myaudioshop_domain_model_brand.pid=###CURRENT_PID### AND tx_myaudioshop_domain_model_brand.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:myaudioshop/Resources/Private/Language/locallang_db.xlf:tx_myaudioshop_domain_model_brand.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
